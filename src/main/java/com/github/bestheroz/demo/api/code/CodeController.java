...
public class CodeController {
  ...
  ResponseEntity<List<CodeDTO>> getItems() {
    return Result.ok(this.codeRepository.getItems().stream().map(CodeDTO::new).toList());
  }
  ...
  ResponseEntity<List<CodeDTO>> getItemsOrderBy(
    ...
    return Result.ok(
        this.codeRepository.getItemsOrderBy(orderByConditions).stream().map(CodeDTO::new).toList());
  }
  ...
  ResponseEntity<List<CodeDTO>> getItemsByMap(
    ...
    return Result.ok(
        this.codeRepository.getItemsByMap(whereConditions).stream().map(CodeDTO::new).toList());
  }
  ...
  ResponseEntity<List<CodeDTO>> getTargetItems(
    ...
    return Result.ok(
        this.codeRepository.getTargetItems(targetColumns).stream().map(CodeDTO::new).toList());
  }
  ...
  ResponseEntity<List<CodeDTO>> getDistinctItems(
    ...
    return Result.ok(
        this.codeRepository.getDistinctItems(distinctColumns).stream().map(CodeDTO::new).toList());
  }
  ...
  public ResponseEntity<List<CodeDTO>> insertBatch(
    ...
    final List<Code> codes = payload.stream().map(CodeInsertDTO::toCode).toList();
